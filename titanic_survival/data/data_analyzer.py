...
class DataAnalyzer:
    ...
    def _facet_grid(self, func, x: List[str], order: List[str] = None, col: str = None, row: str = None,
                    orient: str = 'v',
        ...
        if func == sns.barplot:
            g.map(func, *x, order=order, orient=orient, ci=None, color=color)
        else:
    ...
    def analyze(self) -> None:
        ...
        self._facet_grid(sns.barplot, col='Sex', x=['Survived'], color='#ff9933',
                         save_name='sex_survival.png')
        ...
        self._facet_grid(sns.barplot, col='Pclass', x=['Sex', 'Survived'], order=['female', 'male'], color='#ff33cc',
